(function (m, U) {
  ...
  var is = (m, U, g) =>
    U in m
      ? ss(m, U, { enumerable: !0, configurable: !0, writable: !0, value: g })
      : (m[U] = g);
  var V = (m, U, g) => (is(m, typeof U != "symbol" ? U + "" : U, g), g);
  let U = 0;
  function g() {
    if (!(U > 100)) {
      if (U === 100)
  ...
  let et = class {
    constructor(e) {
      if (((this.type = "Scene"), !e || e.type !== "Renderer"))
        D(this.type + ": Renderer not passed as first argument", e);
      else if (!e.gl) {
        D(this.type + ": Renderer WebGL context is undefined", e);
        return;
      }
  ...
  class q {
    ...
    composeFromOrigin(e, t, s, i) {
      ...
      return (
        ...
        (r[10] = H),
        (r[11] = 0),
        (r[12] = e.x + B - (T * B + L * x + O * y)),
        (r[13] = e.y + x - (C * B + w * x + F * y)),
        (r[14] = e.z + y - (M * B + N * x + H * y)),
        (r[15] = 1),
        this
      );
    }
...
gl.LINEAR filtering will be used instead`,
    ...
    _getSizes() {
      ...
      const e = this._parent.scale
          ? Re.set(this._parent.scale.x, this._parent.scale.y)
          : Re.set(1, 1),
    ...
    setScale(e) {
      ...
      e.sanitizeNaNValuesWith(this.scale).max(Re.set(0.001, 0.001)),
  ...
  class Ve {
    ...
    loadImage(e, t = {}, s, i) {
      ...
      if (
        ...
        (a.sampler =
          typeof e != "string" && e.hasAttribute("data-sampler")
            ...
            : a.sampler),
          (a.fromTexture = r);
        const d = new se(this.renderer, a);
      ...
      a.sampler = h.hasAttribute("data-sampler")
        ...
        : a.sampler;
      const o = new se(this.renderer, a),
    ...
    loadVideo(e, t = {}, s, i) {
      ...
      this._parent && (a = Object.assign(t, this._parent._texturesOptions)),
        ...
        (a.sampler = r.hasAttribute("data-sampler")
          ...
          : a.sampler);
      const h = new se(this.renderer, a),
    ...
    loadCanvas(e, t = {}, s) {
      ...
      this._parent && (i = Object.assign(t, this._parent._texturesOptions)),
        ...
        (i.sampler = e.hasAttribute("data-sampler")
          ? e.getAttribute("data-sampler")
          : i.sampler);
      const r = new se(this.renderer, i);
  ...
  class gt {
    constructor(
      ...
      (this._canDraw = !1),
        ...
        (this._program = new Ue(this.renderer, {
          parent: this,
          vertexShader: r,
          fragmentShader: a,
        })),
    ...
    createTexture(e = {}) {
      const t = new se(this.renderer, Object.assign(e, this._texturesOptions));
...
`,
  ...
  class Ne extends _t {
      ...
      if (s.length === 1)
        s[0] === 0
          ? ((t[0] = this._getIntersection(
            ...
            t.push(
              this._getIntersection(t[3], j.set(-1, -0.95, 0).applyMat4(i)),
            ))
          : s[0] === 1
            ? ((t[1] = this._getIntersection(
              ...
              t.push(
                this._getIntersection(t[2], j.set(1, -0.95, 0).applyMat4(i)),
              ))
            : s[0] === 2
              ? ((t[2] = this._getIntersection(
                ...
                t.push(
                  this._getIntersection(t[1], j.set(1, 0.95, 0).applyMat4(i)),
                ))
              : s[0] === 3 &&
                ...
                t.push(
                  this._getIntersection(t[0], j.set(-1, 0.95, 0).applyMat4(i)),
                ));
      else if (s.length === 2)
        s[0] === 0 && s[1] === 1
          ? ((t[0] = this._getIntersection(
        ...
        (t = [t[r]]),
          r === 0
            ? (t.push(
                this._getIntersection(t[0], G.set(-0.95, 1, 0).applyMat4(i)),
              ),
              t.push(
                this._getIntersection(t[0], j.set(-1, 0.95, 0).applyMat4(i)),
              ))
    ...
    mouseToPlaneCoords(e) {
      if (
        (Be.setAxisOrder(this.quaternion.axisOrder),
        Be.equals(this.quaternion) && St.equals(this.transformOrigin))
      )
    ...
    _createFrameBuffer() {
      (this._frameBuffer = this.gl.createFramebuffer()),
        ...
        this.textures.length
          ...
          : new se(this.renderer, this._texturesOptions).addParent(this),
  ...
  typeof document.hidden < "u"
    ? ((me = "hidden"), (he = "visibilitychange"))
    : typeof document.msHidden < "u"
      ? ((me = "msHidden"), (he = "msvisibilitychange"))
      : typeof document.webkitHidden < "u" &&
        ((me = "webkitHidden"), (he = "webkitvisibilitychange"));
  function zt(n, e) {
    let t;
    return function (...s) {
      clearTimeout(t),
  ...
  function Ce(n, e, t, s, i) {
    if (t.length > 1) {
      ...
      if (
        ...
        f.forEach((p, _) => {
          d.addColorStop(_ * (1 / (f.length - 1)), p);
        });
      } else
        t.forEach((f, p) => {
  ...
  function ye(n) {
    return n.usesPingPong || ["mouse", "waterRipple"].includes(n.type);
  }
  function Z(n, e) {
  ...
  function ae(n) {
    const e =
      ...
      s = n.layerType === "effect" && (n.animating || ye(n)),
      i = n.type === "video";
    return e || t || s || i;
  }
  function It(n, e, t) {
    ...
    return (
      n.forEach((i) => {
        switch (i.layerType) {
          case "text":
            s.push(new Gt(i, e, null, t).unpackage());
            break;
          case "image":
            s.push(new Ht(i, e, t).unpackage());
            break;
          case "shape":
            s.push(new Bt(i, e, t).unpackage());
            break;
          case "effect":
  ...
  function Lt(n, e) {
    ...
    (s.src = ce(
      ...
      (s.alt = ce("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")),
  ...
  function Xe() {
    m.scenes.forEach((n, e) => {
      document.body.contains(n.element) ||
        (n.curtain && n.curtain.dispose(), m.scenes.splice(e, 1));
    });
  }
  function Dt(n) {
    return (
  ...
  function ke() {
    ...
    let n = m.scenes.filter((t) => t.getDynamicLayers().length > 0);
    const e = (t) => {
      let s = !1;
      n.forEach((i) => {
        i.isInView && i.initialized
          ? ((i.rendering = !0),
            ...
            (s =
              m.scenes.filter((r) => r.getDynamicLayers().length > 0).length >
              0))
          : (i.rendering = !1);
      }),
        (!le || t - le > 64) &&
          ...
          (le = t),
          (oe > 1e3 || (oe < 0 && !Ae && !X)) && Ie()),
        s ? (Xt(), (de = requestAnimationFrame(e))) : cancelAnimationFrame(de);
    };
    n.length && (de = requestAnimationFrame(e));
  }
  function be(n, e, t) {
    return (n == null ? void 0 : n.type) === "Vec3" &&
      ...
      : (n == null ? void 0 : n.type) === "Vec2" &&
        ...
        ? new k(n._x + (e._x - n._x) * t, n._y + (e._y - n._y) * t)
        : n + (e - n) * t;
  }
  function Pe(n, e) {
    return (
  ...
  function Fe(n, e, t) {
    if (_e) {
      n.loadImage(_e, { sampler: "uTexture" });
      return;
    }
  ...
  class Ot {
    constructor({
      ...
      (this.prop = e),
        ...
        (this.uniformData = a),
        (this.value = Pe(t)),
        (this.endValue = s !== void 0 ? Pe(s || 0) : null),
      ...
      return (
        ...
        this.progress === 0
          ...
          : (a >= 1 && ((this.complete = !0), (this.progress = 0)),
            (this.lastTick = s),
            this.complete ? !1 : be(this.value, e, this.progress))
      );
    }
    resetState() {
      (this.progress = 0),
  ...
  class Ut {
    ...
    updateEffect(e, { top: t, height: s, isFixed: i }) {
      ...
      if ((i && (t -= X), this.mode === "scrollIntoView")) {
        const r = t + X - te * this.offset,
          a = r + (te + s) * this.range;
        let h = (X - r) / (a - r),
          o = Math.max(0, Math.min(1, h));
        return (
          this.lastTick !== void 0 &&
            (o = re(o, this.lastTick, this.momentum * 2)),
          this.lastTick !== void 0 && Math.abs(this.lastTick - o) < 1e-4
            ? !1
            : ((this.lastTick = o), be(e, this.value, o))
        );
        ...
        return (
          ...
          this.lastTick !== void 0 &&
          ((r = re(r, this.lastTick, this.momentum * 2)), Math.abs(r) < 0.001)
            ? !1
  ...
  class Vt {
    ...
    updateEffect(e, t, s) {
      ...
      const d = He(this.transition.ease)(this.rawProgress),
      ...
      return (
        ...
        !t && !u
          ...
          : (!t &&
            ...
            (this.lastTick = r),
            (this.lastEnterTime = t),
            u ? be(e, this.value, this.progress) : !1)
      );
    }
    resetState() {
      this.progress = 0;
        ...
        for (let i in e.props)
          ((t = e.props[i]) == null ? void 0 : t.type) === "Vec2"
            ...
            : ((s = e.props[i]) == null ? void 0 : s.type) === "Vec3"
              ...
              : typeof e.props[i] == "object" && (e.props[i] = J(e.props[i]));
      }),
      n
    );
  }
  class Ye {
        ...
        (this.states = {
          appear:
            e.states && e.states.appear
              ? e.states.appear.map((s) => new Ot(s))
              : [],
          scroll:
            e.states && e.states.scroll
              ? e.states.scroll.map((s) => new Ut(s))
              : [],
          hover:
            e.states && e.states.hover
              ? e.states.hover.map((s) => new Vt(s))
              : [],
        });
    }
    state() {
      return (
        m.scenes.find((e) => e.id === this.local.sceneId) || this.initOptions
      );
    }
    getIndex() {
      return this.state()
    ...
    updateStateEffects() {
      var s, i;
      if (
        !this.states.appear.some((r) => !r.complete) &&
      ...
      for (const r in this.local.uniformUpdatesPool)
        delete this.local.uniformUpdatesPool[r];
      this.local.hasUpdates = !1;
      const e = this.state(),
        t = (r) =>
          !r.breakpoints || r.breakpoints.length === 0
            ? !0
            : r.breakpoints.find((a) => {
                var h;
                return (
                  a === ((h = e.currentBreakpoint) == null ? void 0 : h.name)
                );
              });
      e.isInView &&
        (this.local.createdAt === null &&
          (this.local.createdAt = performance.now()),
        this.states.appear.forEach((r) => {
          if (!t(r)) return;
          let a = r.startTime || this.local.createdAt;
          if (!r.initialized) {
            const o = [
              ...this.states.appear.filter((l) => l.prop === r.prop),
            ].sort(
              (l, d) => (l.transition.delay || 0) - (d.transition.delay || 0),
            )[0];
            (o == null ? void 0 : o.id) === r.id &&
              ((this.local.uniformUpdatesPool[r.prop] = r.value),
              (this.local.hasUpdates = !0)),
              (r.initialized = !0),
              a || (r.startTime = performance.now());
          }
          e != null &&
            e.pauseTime &&
            (a += Math.abs(e == null ? void 0 : e.pauseTime));
          const h = r.updateEffect(this[r.prop], a);
          h !== !1 &&
            ((this.local.uniformUpdatesPool[r.prop] = h),
            (this.local.hasUpdates = !0)),
            this.isElement &&
              r.complete &&
              this.removeStateEffectProperty(r.prop);
        })),
        this.states.hover.forEach((r) => {
          if (!t(r)) return;
          const a = r.updateEffect(this[r.prop], e.mouse.enterTime, this);
          a !== !1 &&
            ((this.local.uniformUpdatesPool[r.prop] = a),
            (this.local.hasUpdates = !0));
        }),
        this.states.scroll.forEach((r) => {
          ...
          const h = r.updateEffect(this[r.prop], {
            top: e.isFixed ? 0 : (o = e.bbox) == null ? void 0 : o.top,
            height: a.height / 2,
            isFixed: e.isFixed,
          });
          h !== !1 &&
        ...
        this.local.hasUpdates &&
          (this.getPlanes().forEach((r) => {
            var a;
            for (let h in this.local.uniformUpdatesPool) {
              const o = this.local.uniformUpdatesPool[h];
              o !== void 0 &&
                ((a = r.uniforms[h]) == null ? void 0 : a.lastValue) !== o &&
                (r.uniforms[h] && we(o, r.uniforms[h], h),
                this.updateStateEffectProperty(h, o));
            }
          }),
          this.isElement &&
  ...
  let ze = class extends Ye {
    ...
    resize() {
      ...
      this.render(),
        this.layerType === "text" && Ge(this, this.state().element);
    }
    dispose() {
      this.local.canvas &&
  ...
  class Bt extends ze {
    ...
    unpackageType() {
      return (
        (this.fill = J(this.fill)),
        (this.stroke = J(this.stroke)),
        this.render(),
        this
      );
    }
    render() {
      ...
      if (
        ...
        if (
          ...
          let _ = (l * Math.min(Math.abs(a), Math.abs(h))) / 2;
          this.drawRoundedRect(t, 0, 0, a, h, _);
        } else
          this.type === "circle"
            ? t.ellipse(
                a / 2,
  ...
  class Ht extends ze {
    ...
    unpackage() {
      return (this.effects = J(this.effects)), this;
    }
    loadImage() {
      const t = new Image();
    ...
    renderImage() {
      ...
      if (this.fitToCanvas) {
        ...
        const p = (o - a) / 2,
          _ = (l - h) / 2;
        t.drawImage(this.local.img, p, _, a, h);
      } else {
        const c = ne(this.anchorPoint),
          f =
  ...
  class Gt extends ze {
    ...
    unpackage() {
      return (this.fill = J(this.fill)), (this.effects = J(this.effects)), this;
    }
    loadFont() {
    ...
    handleFontLoaded() {
      ...
      const t = this.state();
      t.renderFrame && t.renderFrame(), Ge(this, this.state().element);
    }
    ...
    render() {
      ...
      t.clearRect(0, 0, h.canvasWidth, h.canvasHeight),
        (t.font = `${_} ${R} ${c}px/${f}px ${this.fontFamily}, -apple-system, BlinkMacSystemFont, Helvetica, Arial`),
        this.isSafari ||
          ((t.textAlign = this.textAlign), (t.letterSpacing = p + "px"));
      const S = t.measureText("m").width;
      (r = Math.max(r, S)), t.save();
      let v = l + r / 2,
        A = d + o / 2;
      t.translate(v, A),
        t.rotate((this.rotation * 360 * Math.PI) / 180),
        t.translate(-v, -A),
        this.textAlign === "center" && (l += r / 2),
        this.textAlign === "right" && (l += r),
        (t.fillStyle = Ce(
          t,
          this.box(),
          this.fill,
      ...
      const z = (x, y, T, C, M, L, w) => {
          let N = y
              .split("")
              .reduce(
                (F, H, ts) =>
                  F + x.measureText(H).width + (ts < y.length - 1 ? M : 0),
                0,
              ),
            O;
          if (
            (L === "center" ? (O = T + (w - N) / 2 - w / 2) : (O = T),
            L === "right")
          )
            for (let F = y.length - 1; F >= 0; F--) {
              const H = y[F];
              (O -= x.measureText(H).width),
                x.fillText(H, O, C),
                F > 0 && (O -= M);
            }
          else
            for (let F = 0; F < y.length; F++)
              x.fillText(y[F], O, C), (O += x.measureText(y[F]).width + M);
        },
        I = (x, y) => {
          let T = d + f * y + f / 2 + c / 3;
          this.isSafari
            ? z(t, x, l, T, p, this.textAlign, r)
            : t.fillText(x, l, T);
        },
        P = this.textContent
...
`)
      ...
      const Y = (x, y, T) =>
        y
          ...
          .reduce(
            (M, L, w) => (
              (M += x.measureText(L).width), w < y.length - 1 && (M += T), M
            ),
            0,
          );
      for (let x = 0; x < E; x++) {
        ...
        for (let C = 0; C < T.length; C++) {
          const M = T[C],
            L = y + M;
          if (
            (this.isSafari && p ? Y(t, L, p) : t.measureText(L).width) > r ||
            M ===
              `
`
          ) {
            if (y !== "")
              (P[x] = y.trim()),
                C !== T.length - 1
                  ? (P.splice(x + 1, 0, T.slice(C).join("")), E++)
                  : M !==
                      `
` && P.push(M);
            else {
              ...
              for (; N.length > 0; ) {
                ...
                for (
                  let H = 0;
                  H < N.length &&
                  (t.measureText(F + N[H]).width <= r || H == 0);
                  H++
                )
                  F += N[H];
                (N = N.slice(F.length)),
                  (P[O] = F.trim()),
                  N.length > 0 && (P.splice(O + 1, 0, N), O++, E++);
              }
              T.slice(C + 1).length > 0 && (P[O] += T.slice(C + 1).join(""));
            }
            break;
          } else y = L;
          C === T.length - 1 && (P[x] = y.trim());
        }
      }
      P.forEach((x, y) => {
        I(x, u), y < P.length - 1 && u++;
      }),
        t.translate(-(l + r / 2), -(d + o / 2)),
        t.restore(),
        (this.height = f * u + f);
    }
  }
  ...
  function qe(n, e, t = 50) {
    const s = e || n.getBoundingClientRect(),
      i =
        (s.top >= -t && s.top <= te + t) ||
        (s.bottom >= -t && s.bottom <= te + t) ||
        (s.top <= 0 && s.bottom >= te),
      r =
        (s.left >= -t && s.left <= Q + t) ||
        (s.right >= -t && s.right <= Q + t) ||
        (s.left <= 0 && s.right >= Q);
    return i && r;
  }
  function Ie() {
  ...
  function Qe(n) {
    const e = m.scenes.filter((i) => i.getDynamicLayers().length),
      t = m.scenes.filter((i) => i.rendering);
    e.length && !t.length && ke();
    const s = performance.now();
    (!le || s - le > 64) && Ie(),
      e.forEach((i) => {
  ...
  class Yt {
    constructor(e) {
      V(this, "local", { preloadedTextures: {} });
      V(this, "scrollY", 0);
      (this.id = e.id),
        (this.breakpoints = [
        ...
        (this.canvasWidth = e.width || e.element.offsetWidth || Q),
        (this.canvasHeight = e.height || e.element.offsetHeight || te),
        (this.curtain = void 0),
        ...
        this.createCurtains(),
        this.setCanvasScale(),
        this.curtain && (this.textureLoader = new Ve(this.curtain));
    }
    preloadTextures() {
      this.layers.forEach((e) => {
        ...
        if (e.isElement)
          ...
          if (e.type === "video" && e.src) {
            const u = e.src.includes(", ") ? je(e.src) : e.src,
              c = u;
    ...
    destroy() {
      ...
      (e = this.curtain) != null &&
        ...
        (this.layers = []),
        (m.scenes = m.scenes.filter((s) => s.id !== this.id)),
        m.scenes.length || Le();
    }
    resize() {
      this.setCanvasScale(),
              ...
              e.local.bpProps &&
                Object.keys(e.local.bpProps).forEach((i) => {
                  e.getPlanes().forEach((r) => {
                    r.uniforms[i] && we(e.local.bpProps[i], r.uniforms[i], i);
                  });
                })),
    ...
    getDynamicLayers() {
      return this.layers.filter((e) => ae(e));
    }
    createCurtains() {
      (this.curtain = new at({
      ...
      if (s) {
        let i = s.parentLayer ? s.getParent() : null,
          ...
          a =
            ...
            i.effects &&
            i.effects.length &&
            i.getChildEffectItems().filter((h) => ae(h)).length;
        for (; s && !ae(s) && !r && !a; )
          t++,
            (s = e[t]),
            s &&
          ...
          (i[c] = e.data.uniforms[c]),
            ((d = f.value) == null ? void 0 : d.type) === "Vec3"
              ...
              : ((u = f.value) == null ? void 0 : u.type) === "Vec2"
                ? (i[c].value = new k(f.value._x, f.value._y))
                : typeof f.value == "object" && (i[c].value = J(f.value));
        }
      return {
        fragmentShader: r,
        vertexShader: a,
      ...
      try {
        ...
        if (
          ...
          e.userDownsample &&
            ...
            (o *= e.userDownsample),
          (r = new Ne(this.curtain, this.curtain.container, i)),
    ...
    handleMediaTextures(e, t, s) {
      ...
      if (
            ...
            if (
              ...
              o
                ...
                : this.textureLoader.loadImage(
                    ...
                    (l) => {
                      W(e, r.sampler, l), (e.userData.textureLoaded = !0);
                    },
                  );
            }
          }),
        ...
        const r = t.src.includes(", ") ? je(t.src) : t.src,
    ...
    handleEffectPlane(e, t, s) {
      ...
      a &&
        ...
        W(i, "uPingPongTexture", a.getTexture()),
        r
          ? W(i, "uTexture", r.getTexture())
          : Fe(i, this.canvasWidth, this.canvasHeight),
        h != null &&
          h.includes("uBgTexture") &&
          i &&
    ...
    handleElementPlane(e, t) {
      ...
      if (
        ...
        a || Fe(s, this.canvasWidth, this.canvasHeight),
        a && i.length && s
          ? W(s, "uTexture", a.getTexture())
        ...
        a &&
          (W(s, "uBgTexture", a.getTexture()),
          o && e.mask && W(s, "uPreviousLayerTexture", o.getTexture()));
      }
    }
    handleChildEffectPlane(e, t, s) {
      ...
      let a = this.getRenderTargets()[t - 1],
        ...
        l = r.effects.filter((f) => {
          if (this.layers.find((p) => p.parentLayer === f))
            return this.layers.find((p) => p.parentLayer === f);
        }),
      ...
      if (
        ...
        h &&
          ...
          W(i, "uPingPongTexture", h.getTexture()),
        o != null && o.includes("uBgTexture"))
      )
        if (d && s.length > 1) {
          let f = this.getRenderTargets()[t - (1 + s.length)];
          W(i, "uBgTexture", f.getTexture());
        } else
          (r.preloadedCanvasTexture._samplerName = "uBgTexture"),
            i.addTexture(r.preloadedCanvasTexture);
      e.type === "custom" && W(i, "uCustomTexture", this.getRenderTargets()[t]),
        this.handleMediaTextures(i, e, s);
    }
    createPlanes() {
    ...
    createEffectPlanes(e, t) {
      ...
      s.passes && s.passes.length
        ? (this.createEffectPlane(e, t, {
          ...
          ye(e) && this.createPingPongPlane(e, t, s.passes))
        : (this.createEffectPlane(e, t),
          ye(e) && this.createPingPongPlane(e, t));
    }
    createTextures() {
    ...
    assignRenderTargetToPlane(e, t, s, i) {
      let r = this.getTextureParams(e, t, s),
        a = this.getRenderTargets()[t] || new Se(this.curtain, r);
        ...
        for (let a in e.uniforms)
          ((r = t.states) != null && r.scroll.some((h) => h.prop === a)) ||
            (t.local.bpProps && a in t.local.bpProps
              ? we(t.local.bpProps[a], e.uniforms[a], a)
              : a in t && we(t[a], e.uniforms[a], a));
        s &&
          i &&
          i.index < i.length - 1 &&
          e.uniforms.isMask &&
    ...
    setElementPlaneUniforms(e, t) {
      let s = this.bbox.width * 0.5,
        i = this.bbox.height * 0.5;
      if (e.uniforms.mousePos) {
        ...
        if (this.mouse.movedInView && t.mouseMomentum && t.type !== "mouse") {
          ...
          (r = re(r, l, t.mouseMomentum * 2)),
            (a = re(a, d, t.mouseMomentum * 2)),
            (h = r / s),
            (o = 1 - a / i),
            (t.local.lastMousePos.x = h),
            (t.local.lastMousePos.y = o);
        }
        this.mouse.movedInView &&
          (e.uniforms.mousePos.value.x !== h ||
            e.uniforms.mousePos.value.y !== o) &&
          ((e.uniforms.mousePos.value.x = h),
          (e.uniforms.mousePos.value.y = o));
      }
    }
    calculateItemMouseValues(e) {
      ...
      if (e.mouseMomentum && e.type !== "mouse") {
        ...
        let h = e.local.lastMousePos.x * t,
          o = (1 - e.local.lastMousePos.y) * s;
        (i = re(i, h, e.mouseMomentum * 2)),
          (r = re(r, o, e.mouseMomentum * 2)),
          (e.local.lastMousePos.x = i / t),
          (e.local.lastMousePos.y = 1 - r / s);
      }
      this.local.mouseValuePool ||
        (this.local.mouseValuePool = {
          mousePos: new k(0.5, 0.5),
          previousMousePos: new k(0.5, 0.5),
          result: { mousePos: null, previousMousePos: null },
        });
      const a = this.local.mouseValuePool;
      return (
        (a.mousePos.x = i / t),
        (a.mousePos.y = 1 - r / s),
        this.mouse.trail.length > 2
          ? ((a.previousMousePos.x =
              this.mouse.trail[this.mouse.trail.length - 3][0]),
            (a.previousMousePos.y =
              this.mouse.trail[this.mouse.trail.length - 3][1]))
          : ((a.previousMousePos.x = a.mousePos.x),
            (a.previousMousePos.y = a.mousePos.y)),
        (a.result.mousePos = a.mousePos),
        (a.result.previousMousePos = a.previousMousePos),
        a.result
      );
    }
  ...
  function qt() {
    K(window, "scroll", Qe),
      xe() ? K(window, "touchmove", ve) : K(window, "mousemove", ve),
      K(window, "routeChange", Xe),
      K(document, "mouseleave", Ze),
      (ie = zt(jt, 16)),
      xe() ? K(window, "orientationchange", ie) : K(window, "resize", ie),
      K(document, he, $e),
      (Me = !0);
  }
  function Le() {
    ee(window, "mousemove", ve),
      ee(window, "touchmove", ve),
      ee(window, "scroll", Qe),
      ee(window, "routeChange", Xe),
      ee(document, "mouseleave", Ze),
      ie && (ee(window, "resize", ie), ee(window, "orientationchange", ie)),
      ee(document, he, $e),
      (Me = !1);
  }
  function Qt(n, e, t) {
      ...
      Jt(e, t, n.filePath, i, n.production)
        .then((r) => {
          ...
          let l = n.scale || a.scale || 1,
            d = n.dpi || Math.min(1.5, window.devicePixelRatio);
          const u = It(r.history, o, Qt(h, l, d)),
            c = new Yt({
              id: o,
              fps: n.fps || a.fps || 60,
              dpi: d,
          ...
          let f = a[ce("ZnJlZVBsYW4=")];
          (f || a[ce("aW5jbHVkZUxvZ28=")]) && Lt(o, h),
            f && console.log(ce("TWFkZSB3aXRoIHVuaWNvcm4uc3R1ZGlv")),
            m.scenes.push(c),
            (c.layers = u),
            c.preloadTextures(),
    ...
    return Kt()
      ? new Promise((n, e) => {
          ...
          t.filter((s) => !s.getAttribute("data-us-initialized")).forEach(
            (s, i) => {
              const r = Z(s, "data-us-project"),
                a = Z(s, "data-us-project-src"),
                h = Z(s, "data-us-dpi"),
                o = Z(s, "data-us-scale"),
                l = Z(s, "data-us-lazyload"),
                d = Z(s, "data-us-production"),
                u = Z(s, "data-us-fps"),
                c = Z(s, "data-us-alttext"),
                f = Z(s, "data-us-arialabel"),
                p = Z(s, "data-us-disablemobile");
